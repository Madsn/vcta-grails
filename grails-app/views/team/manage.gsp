		...
		<div class="col-md-7">
			<g:if test="${SettingsController.manageAllowed()}">
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						<p>Remove all team members and delete the team. Can not be
							undone.</p>
						...
						<div class="invitebutton">
							<div style="text-align: center;">
								<button onclick="$('.invitationform').show();$(this).hide();"
									...
									<i class="glyphicon glyphicon-user"></i> Invite a user
								</button>
							</div>
						</div>
							...
							<g:form controller="invitation" action="save"
								...
								<fieldset>
									<div class="form-group col-md-9" style="padding-top: 5px;">
										<g:select name="userid" from="${users}" class="form-control chosen-select"
											value="${fieldValue(bean: invitation, field: 'invitee.id')}"
											optionKey="id" />
									</div>
									<div class="form-group col-md-1">
										<button type="submit" class="btn btn-primary">
											<i class="glyphicon glyphicon-envelope"></i> Send invitation
										</button>
									</div>
								</fieldset>
							</g:form>
