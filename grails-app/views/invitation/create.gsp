			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<g:select name="userid" from="${users}" class="form-control"
						value="${fieldValue(bean: invitation, field: 'invitee.id')}" optionKey="id" optionValue="username" />
				</div>
			</div>

			<div class="form-group">
				<div class="col-md-offset-6 col-md-2">
					<g:link controller="team" action="manage"><input type="button" class="btn btn-danger" value="Cancel"/></g:link>
