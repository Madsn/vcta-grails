						...
						<g:if test="${user.team?.leader == user}">
							...
							<div style="text-align: center;">
								<button class="btn btn-primary"
									onClick="window.location = '/team/manage/${user.team?.id}' ">
									Open team management page</button>
							</div>
						</g:if>
						<g:else>
								...
								<div class="pull-right">
									<g:form controller="team" action="removefromteam"
										...
										<button class="btn btn-danger" type="button"
											...
											data-confirm="Leave team">Leave current team</button>
									</g:form>
								</div>
							</g:if>
							<g:else>
								<div id="createteambtn" style="text-align: center;">
									<button
